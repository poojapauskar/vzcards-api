...
class ApiSerializer(serializers.ModelSerializer):
    class Meta:
        model = Api
        fields = ('vzcards','register','verify','send_again','sync', 'my_profile','my_profile_update','get_my_friends','get_list', 'get_my_tickets','connect','ticket_create','ticket_details','response','reffered','upload_image','history','remove_ticket')
    ...
    def update(self, instance, validated_data):
        ...
        instance.remove_ticket = validated_data.get('remove_ticket', instance.remove_ticket)
