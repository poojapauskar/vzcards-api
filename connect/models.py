...
class Connect(models.Model):
 ...
 phone_1 = models.CharField(max_length=13,validators=[phone_regex], blank=False)
 ticket_id_1 = models.CharField(max_length=100, blank=True, default='')
 phone_2 = models.CharField(max_length=13,validators=[phone_regex], blank=False)
 ticket_id_2 = models.CharField(max_length=100, blank=True, default='')
 reffered_phone = models.CharField(max_length=13,validators=[phone_regex], blank=True)
